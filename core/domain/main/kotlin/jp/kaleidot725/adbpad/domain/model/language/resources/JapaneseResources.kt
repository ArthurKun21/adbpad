...
object JapaneseResources : StringResources {
    ...
    override val appPathInfo: String = "パス情報"
    ...
    override val commandAirplaneModeOnTitle: String = "機内モード: ON"
    override val commandAirplaneModeOnDetails: String = "機内モードを有効化し、すべての無線通信を無効化する"
    override val commandAirplaneModeOffTitle: String = "機内モード: OFF"
    override val commandAirplaneModeOffDetails: String = "機内モードを無効化し、無線通信を有効化する"
    override val commandBluetoothOnTitle: String = "Bluetooth: ON"
    override val commandBluetoothOnDetails: String = "Bluetooth通信を有効化する"
    override val commandBluetoothOffTitle: String = "Bluetooth: OFF"
    override val commandBluetoothOffDetails: String = "Bluetooth通信を無効化する"
    override val commandLocationOnTitle: String = "位置情報: ON"
    override val commandLocationOnDetails: String = "位置情報サービスを有効化する"
    override val commandLocationOffTitle: String = "位置情報: OFF"
    override val commandLocationOffDetails: String = "位置情報サービスを無効化する"
    override val commandAnimationsOnTitle: String = "アニメーション: ON"
    override val commandAnimationsOnDetails: String = "ウィンドウアニメーションとトランジションを有効化する"
    override val commandAnimationsOffTitle: String = "アニメーション: OFF"
    override val commandAnimationsOffDetails: String = "ウィンドウアニメーションとトランジションを無効化する"
    override val commandAutoRotateOnTitle: String = "自動回転: ON"
    override val commandAutoRotateOnDetails: String = "画面の自動回転を有効化する"
    override val commandAutoRotateOffTitle: String = "自動回転: OFF"
    override val commandAutoRotateOffDetails: String = "画面の自動回転を無効化する"
    override val commandFontScaleSmallTitle: String = "フォントサイズ: 小"
    override val commandFontScaleSmallDetails: String = "フォントサイズを小さく設定する (0.85倍)"
    override val commandFontScaleNormalTitle: String = "フォントサイズ: 標準"
    override val commandFontScaleNormalDetails: String = "フォントサイズを標準に設定する (1.0倍)"
    override val commandFontScaleLargeTitle: String = "フォントサイズ: 大"
    override val commandFontScaleLargeDetails: String = "フォントサイズを大きく設定する (1.15倍)"
    override val commandFontScaleHugeTitle: String = "フォントサイズ: 最大"
    override val commandFontScaleHugeDetails: String = "フォントサイズを最大に設定する (1.3倍)"
    override val commandFontScaleExtraLargeTitle: String = "フォントサイズ: 特大"
    override val commandFontScaleExtraLargeDetails: String = "フォントサイズを特大に設定する (1.5倍)"
    override val commandFontScaleMaximumTitle: String = "フォントサイズ: 極大"
    override val commandFontScaleMaximumDetails: String = "フォントサイズを極大に設定する (2.0倍)"
    override val commandRtlLayoutOnTitle: String = "RTLレイアウト: ON"
    override val commandRtlLayoutOnDetails: String = "右から左へのレイアウトを有効化する"
    override val commandRtlLayoutOffTitle: String = "RTLレイアウト: OFF"
    override val commandRtlLayoutOffDetails: String = "右から左へのレイアウトを無効化する"
    override val commandBatterySaverOnTitle: String = "バッテリーセーバー: ON"
    override val commandBatterySaverOnDetails: String = "バッテリーセーバーモードを有効化する"
    override val commandBatterySaverOffTitle: String = "バッテリーセーバー: OFF"
    override val commandBatterySaverOffDetails: String = "バッテリーセーバーモードを無効化する"
    override val commandDataSaverOnTitle: String = "データセーバー: ON"
    override val commandDataSaverOnDetails: String = "データセーバーモードを有効化し、バックグラウンドデータを制限する"
    override val commandDataSaverOffTitle: String = "データセーバー: OFF"
    override val commandDataSaverOffDetails: String = "データセーバーモードを無効化する"
    override val commandDozeModeOnTitle: String = "Dozeモード: ON"
